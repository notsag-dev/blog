...
So, should these paths be visible or not? First of all navigate them, see what information can be obtained from them. Then, for standard paths it will be enough to Google (or Duckduckgo) a bit in order to determine if they should be publicly available or not, do your investigation depending on your scan results!
